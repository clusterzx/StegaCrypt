...
#Region "Compile"
    ...
    ''' </summary>
    Public Sub Compile(ByVal OutputPath As String, ByVal resfile As String)
        If Not String.IsNullOrEmpty(_source) Then
            If Not String.IsNullOrEmpty(OutputPath) Then
                ...
                'Using res As New ResourceWriter(Application.StartupPath & "\resources.resources")
                '    res.AddResource("InstallBG", Image.FromFile(My.Computer.FileSystem.CurrentDirectory & "\tempbild.png"))
                '    res.Generate()
                '    res.Close()
                'End Using
                'p.EmbeddedResources.Add(Application.StartupPath & "\resources.resources")

                
                    p.EmbeddedResources.Add(resfile)
